...
public class LevelLoader {
    ...
    public static Level load(String levelName, Viewport viewport) {
        ...
        String levelFile = Constants.LEVEL_DIR + File.separator + levelName + "." + Constants.LEVEL_FILE_EXTENSION;
        ...
        try {
            ...
            JSONObject rootJsonObject = (JSONObject) jsonParser.parse(file.reader());
