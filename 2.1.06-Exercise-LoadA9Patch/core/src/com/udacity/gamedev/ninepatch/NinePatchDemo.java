...
public class NinePatchDemo extends ApplicationAdapter {
    ...
    public void create() {
        ...
        platformNinePatch = new NinePatch(platform, EDGE, EDGE, EDGE, EDGE);
    }
    ...
    public void render() {
        ...
        batch.draw(platform, 0, TEST_SIZE_1, TEST_SIZE_2, TEST_SIZE_2);
        // TODO: Draw the nine patch at TEST_SIZE_1
        platformNinePatch.draw(batch, TEST_SIZE_1, 0, TEST_SIZE_1, TEST_SIZE_1);
        // TODO: Draw the nine patch at TEST_SIZE_2
        platformNinePatch.draw(batch, TEST_SIZE_2, TEST_SIZE_1, TEST_SIZE_2, TEST_SIZE_2);
        batch.end();
    }
